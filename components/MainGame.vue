<template>
    <div class="main-container-game">
      <div class="header">
        ...
        <a v-b-modal.game-settings><i class="fa-solid fa-gears"></i></a>
      ...
      <b-modal id="game-settings" 
        no-close-on-backdrop 
        ok-only
        centered 
        title="Settings">
          <b-button v-b-modal.modal-settings pill danger class="button-design-settings">Quit Game</b-button>
      </b-modal>
    </div> 
